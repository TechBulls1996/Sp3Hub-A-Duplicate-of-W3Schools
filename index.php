...
<body>
	...
	<div class="wrapper">
		...
		<div class=" col-sm-12 slider"><!-- slider -->
			...
			<div class="row">
				<div class="col-sm-12  cenh text-center">
					<h1><small> WHAT DO YOU WANT LEARN ?</small> </h1>
				</div>
			...
			<div class="row">
								...
								<div class="row">
									<div class="container-fluid col-sm-12">
										<table class="table table-striped table-hover" width="">
											<tr>
												<th>S.no</th>
												<th>New Tutorials <code>[ With Example]</code></th>
												<th>Go!</th>
											</tr>
											<tr>
												<td>1</td>
												<td>Html 5 <code> New*</code></td>
												<td><input type="button" class="btn btn-sm btn-info " value="click"></td>
											</tr>
											<tr>
												<td>2</td>
												<td>css 3 <code> New*</code></td>
												<td><input type="button" class="btn btn-sm btn-info " value="click"></td>
											</tr>
											<tr>
												<td>3</td>
												<td>Wordpress <code> New*</code></td>
												<td><input type="button" class="btn btn-sm  btn-info" value="click"></td>
											</tr>
											<tr>
												<td>4</td>
												<td>Php ++ <code> New*</code></td>
												<td><input type="button" class="btn btn-sm  btn-info" value="click"></td>
											</tr>
											<tr>
								...
								<div class="row">
									<div class="container  col-xs-12">
										<table class="table table-striped table-hover" width="">
											<tr>
												<th>S.no</th>
												<th>New Projects <code>[with Source Code ]</code></th>
												<th>Go!</th>
											</tr>
											<tr>
												<td>1</td>
												<td>Php <code> New*</code></td>
												<td><input type="button" class="btn btn-sm btn-warning " value="click"></td>
											</tr>
											<tr>
												<td>2</td>
												<td>Wordpress <code> New*</code></td>
											...
											<tr>
												<td>3</td>
												<td>Joomla <code> New*</code></td>
												<td><input type="button" class="btn btn-sm  btn-warning" value="click"></td>
											</tr>
											<tr>
												<td>4</td>
												<td>Bootstrap <code> New*</code></td>
												<td><input type="button" class="btn btn-sm  btn-warning" value="click"></td>
											</tr>
											<tr>
				...
				<div class="col-sm-12 infor ">
					<div class="col-sm-6 inf1">
						<center>

							<div style="border:1px solid grey" class="">
								<br>
								<div class="">
									<img src="Images/pexels-photo-212286.jpeg" class="img img-responsive img-circle img-thumbnail inf11 " style="height:200px; width:200px;">
									<hr>
								</div>
					...
					<div class="col-sm-6 inf1 ">
						<center>
							<div style="border:1px solid grey">
								...
								<img src="Images/pexels-photo-256548.jpeg" class="img img-responsive img-circle img-thumbnail inf11" style="height:200px; width:200px; ">
								<hr>
								<h2> <small><mark>Programming World</mark></small></h2>
								<p> It’s a curious thing about our industry: not only do we not
									learn from our mistakes, we also don’t learn from our successes. <mark>
